      ...
      <nav className="bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex lg:items-center lg:space-x-4 ml-8">
              ...
              <Link
                to={"/login"}
                className="px-4 py-2 border border-purple-600 text-purple-600 dark:text-white rounded-lg hover:bg-purple-50 dark:hover:bg-gray-800 text-sm font-medium"
              >
                Login
              </Link>
            </div>
        ...
        <div className={`lg:hidden ${isMobileMenuOpen ? "block" : "hidden"}`}>
          ...
          <div className="px-2 pt-2 pb-4 space-y-2">
            ...
            <Link
              to={"/login"}
              className="block w-full text-center px-4 py-2 border border-purple-600 text-purple-600 dark:text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-sm font-medium"
            >
              Login
            </Link>
          </div>
