...
import { FiMail, FiPhone, FiMapPin, FiBriefcase, FiDownload, FiArrowLeft } from 'react-icons/fi';
...
const JobSeekerDetail = () => {
  ...
  const applicants = [
    ...
    },
    {
      ...
      coverLetter: 'With 5 years of backend development experience, I have designed and implemented scalable server architectures handling over 1 million daily requests. I am proficient in optimizing database performance and implementing secure API gateways. I look forward to contributing to your engineering team.',
    ...
    },
    {
      ...
      coverLetter: 'As a UX Designer with 4 years of experience, I have created intuitive user interfaces that have increased customer satisfaction scores by 35% across various platforms. My user-centered design approach aligns well with your commitment to exceptional user experiences.',
    ...
    },
    {
      ...
      coverLetter: 'I bring 6 years of digital marketing experience with a proven track record of developing strategies that increased brand visibility and conversion rates. My data-driven approach to marketing has consistently delivered ROI exceeding 200% on campaigns.',
      skills: ['Digital Marketing', 'SEO', 'Content Strategy', 'Analytics', 'PPC'],
    },
    {
      id: 5,
      name: 'Priya Patel',
      ...
      coverLetter: 'As a passionate frontend developer with 2 years of experience, I specialize in creating performant and accessible web applications. I have successfully led the redesign of key product features that improved page load times by 50%.',
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Applicant Details</h1>
              <p className="text-sm sm:text-base text-gray-600 mt-1">Review all details for {applicant.name}</p>
            </div>
            <button
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full
                        ...
                        ${applicant.status === 'Reviewed' ? 'bg-green-100 text-green-800' : ''}
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm text-gray-900">{applicant.experience}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="md:col-span-2">
              ...
              <div>
                ...
                <div className="bg-gray-100 border border-dashed border-gray-300 rounded-lg p-8 text-center">
                  ...
                  <p className="text-sm text-gray-500 mb-2">Preview of {applicant.resume}</p>
                  <button 
                    onClick={handleDownload}
